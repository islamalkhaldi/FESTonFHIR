...
@XmlRootElement(name = "MengdeBestanddel")
public class MengdeBestanddel
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MengdeBestanddel)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final MengdeBestanddel that = ((MengdeBestanddel) object);
        {
            PQ lhsMengde;
